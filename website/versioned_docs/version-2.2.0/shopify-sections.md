...
#### Option color
It creates an option to modify the color of section texts. Insert a Text item and add the attribute:

> option:color={Option Name}

#### Option background color
It creates an option to modify the background color of the section. Insert a Text item and add the attribute:

> option:bgcolor={Option Name}
